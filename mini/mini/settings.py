...
EMAIL_HOST_USER = ''  # The email account used to send emails
EMAIL_HOST_PASSWORD = ''  # The password for that email account

# Default email address to use for sending emails
DEFAULT_FROM_EMAIL = 'your-email@example.com'  # This is the default sender email used in the app

# Admin email(s) for notifications (where business approval requests will be sent)
ADMIN_EMAIL = ''  # Email address where admin notifications will go
