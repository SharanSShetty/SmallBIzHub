...
class BusinessAdmin(admin.ModelAdmin):
    list_display = ('name', 'shop', 'mobile_number', 'business_type', 'approval_status')
    list_filter = ('approval_status', 'business_type')  # Filters in the admin sidebar
    search_fields = ('name', 'shop', 'mobile_number', 'business_type')  # Searchable fields
